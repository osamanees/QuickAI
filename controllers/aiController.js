...
export const generteArticle = async(req, res)=>{
    try {
...
export const resumeReview = async(req, res)=>{
    ...
    const prompt = `Review the following and provide constructive feedback on its strengths, weaknesses, and area for improvement.
     Resume Content:\n\n${pdfData.text} `
